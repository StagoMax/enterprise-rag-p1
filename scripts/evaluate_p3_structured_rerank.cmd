...
uv run python "%PROJECT_ROOT%\scripts\evaluate_p2.py" ^
  ...
  --reranker-cache-path "%PROJECT_ROOT%\artifacts\p3-structured-parent-rerank-v2-cache-deepseek-v4-flash.jsonl" ^
  --answer-generator extractive ^
  --category rag ^
  --gold-path "%PROJECT_ROOT%\data\processed\techqa_p3\golden_questions.curated.jsonl" ^
  --output "%PROJECT_ROOT%\reports\p3-structured-parent-rerank-v2-deepseek-v4-flash-%STRATEGY%.json"
